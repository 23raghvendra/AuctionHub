...
const ViewMyAuctions = () => {
  ...
  // Show All auctions (Active, Upcoming, Ended)
  const allMyAuctions = myAuctions;
  ...
  return (
    <div className="w-full min-h-screen bg-zinc-50 lg:pl-[280px] py-12 px-6">
      ...
      >
        <div className="mb-10">
          <h1 className="text-4xl font-black text-zinc-900 mb-2">My Auctions</h1>
          <p className="text-zinc-500 text-lg">Manage all your auctions (Active & Ended)</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {allMyAuctions.length > 0 ? (
              allMyAuctions.map((element, index) => (
                <motion.div
                  key={element._id}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <div className="col-span-full text-center py-20">
                ...
                <h3 className="text-xl font-bold text-zinc-900">No auctions created yet</h3>
